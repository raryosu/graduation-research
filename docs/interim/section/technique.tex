...
\figurenum{fig:x-means}aは4つの等方Gauss分布から生成されたデータである．
...
\figurenum{fig:x-means}bの場合，青色のクラスタでは，親のBICが子クラスタのものに比べ大きいが，
...
\begin{figure}[htbp]
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \includegraphics[width=60mm]{img/xmeans/a.pdf}
    \end{center}
  \end{minipage}
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \includegraphics[width=60mm]{img/xmeans/b.pdf}
    \end{center}
  \end{minipage}\\
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \includegraphics[width=60mm]{img/xmeans/c.pdf}
    \end{center}
  \end{minipage}
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \includegraphics[width=60mm]{img/xmeans/d.pdf}
    \end{center}
  \end{minipage}\\
  \caption{X-meansの動作}
  \label{fig:x-means}
