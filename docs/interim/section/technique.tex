...
\begin{figure}[htbp]
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \includegraphics[width=60mm]{img/xmeans/a.jpg}
    \end{center}
  \end{minipage}
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \includegraphics[width=60mm]{img/xmeans/b.jpg}
    \end{center}
  \end{minipage}\\
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \includegraphics[width=60mm]{img/xmeans/c.jpg}
    \end{center}
  \end{minipage}
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \includegraphics[width=60mm]{img/xmeans/d.jpg}
    \end{center}
  \end{minipage}\\
  \caption{X-meansの動作}
  \label{fig:x-means}
